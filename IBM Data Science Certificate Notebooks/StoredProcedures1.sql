...
--Create a stored procedure routined names RETRIEVE_ALL. 
--This routine will contain a SQL query to retrieve all the records from the petsale table, so you don't need to write the same query repeatedly. You call the stored procedure routine to execute the query every time.
--#SET TERMINATOR @
